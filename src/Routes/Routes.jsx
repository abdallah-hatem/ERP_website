...
import TaxReportClosing from "../Pages/Closing/TaxReportClosing";
...
import AddIncomeTax from "../Pages/TAX/AddIncomeTax";
import ManageIncomeTax from "../Pages/TAX/ManageIncomeTax";
import TaxReport from "../Pages/TAX/TaxReport";
import InvoiceWiseTaxReport from "../Pages/TAX/InvoiceWiseTaxReport";
...
import Settings from "../Pages/Settings/SoftwareSettings/Settings";
import PrintSettings from "../Pages/Settings/SoftwareSettings/PrintSettings";
import MailSettings from "../Pages/Settings/SoftwareSettings/MailSettings";
import AddRole from "../Pages/Settings/RolePermission/AddRole";
import RoleList from "../Pages/Settings/RolePermission/RoleList";
import UserAssignRole from "../Pages/Settings/RolePermission/UserAssignRole";
import SmsSettings from "../Pages/Settings/SmsSettings";
import Restore from "../Pages/Settings/DataSynchronizer/Restore";
...
import CoaPrint from "../Pages/Accounts/Report/CoaPrint";
  ...
  },
  {
    ...
    data: [
      ...
      },
      {
        ...
        title: "Tax Report",
        icon: "menu-icon fa fa-cogs",
        path: "/tax-report-closing",
        component: <TaxReportClosing />,
      },
      {
        id: 0,
  ...
  },
  {
    ...
    data: [
      ...
      },
      {
        ...
        icon: "menu-icon fa fa-cogs",
        path: "/manage-income-tax",
        component: <ManageIncomeTax />,
      },
      {
        id: 0,
        title: "Tax Report",
      ...
      },
      {
        ...
        icon: "menu-icon fa fa-cogs",
        path: "/tax-report-invoice",
        component: <InvoiceWiseTaxReport />,
      },
    ],
  },
  {
    ...
    data: [
      ...
      },
      {
        ...
        icon: "menu-icon fa fa-cogs",
        path: "/supplier-return-list",
        component: <SupplierReturnList />,
      },
      {
        id: 0,
        title: "Wastage Return List",
        icon: "menu-icon fa fa-cogs",
        path: "/wastage-return-list",
        component: <WastageReturnList />,
      },
    ],
  },
  {
...
export const singleRoutes = [
  ...
  {
    path: "manage-users/employee-profile/:id",
    component: <EmployeeProfile />,
  },
  {
