...
function MailSettings() {
   ...
   const DataCol2 = [
      {
         label: "Sale :",
         component: children("sale", saleRadio, values["sale"]),
         removeContainer: true,
      },
      {
         label: "Service :",
         component: children("service", serviceRadio, values["service"]),
         removeContainer: true,
      },
      {
         label: "Quotation :",
         component: children("quotation", quotationRadio, values["quotation"]),
         removeContainer: true,
      },
   ];
